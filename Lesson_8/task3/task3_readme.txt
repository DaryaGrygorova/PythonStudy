...
# https://www.geeksforgeeks.org/wc-command-linux-examples/ or in case you have
...
# file­name. Such a filename generally might be passed-in, hard-coded,
# input with input(), or pulled from a command-line via the sys.argv list;
...
#
# Test your module interactively, using import and name qualification to fetch your
# exports.
#
# Does your PYTHONPATH need to include the directory where you created mymod.py?
#
# Try running your module on itself: e.g., test("mymod.py"). Note that the test
# opens the file twice; if you’re feeling ambitious, you may be able to improve
